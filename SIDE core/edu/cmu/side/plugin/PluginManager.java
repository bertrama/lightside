...
public class PluginManager {
	...
	public FEPlugin[] getFEPluginArray(){
		SIDEPlugin[] feSIDEPluginArray = this.getSIDEPluginArrayByType(FEPlugin.type);
		FEPlugin[] fePluginArray = Arrays.copyOf(feSIDEPluginArray, feSIDEPluginArray.length, (new FEPlugin[0]).getClass());
		return fePluginArray;
	}
