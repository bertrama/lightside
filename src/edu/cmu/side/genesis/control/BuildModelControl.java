...
public class BuildModelControl extends GenesisControl{
	...
	private static Collection<ModelEvaluationPlugin> modelEvaluationPlugins;
	...
	static{
		...
		modelEvaluationPlugins = new ArrayList<ModelEvaluationPlugin>();
		SIDEPlugin[] tableEvaluations = PluginManager.getSIDEPluginArrayByType("model_evaluation");
		for(SIDEPlugin fe : tableEvaluations){
			modelEvaluationPlugins.add((ModelEvaluationPlugin)fe);
		}

	}
	
	public static Collection<ModelEvaluationPlugin> getModelEvaluationPlugins(){
